...
class Ectoplasm(Scene):
	...
	def enter(self):
        ("You have decided to explore where the ectoplasm leads. You see that the trail leads to the laundry room. It's quite ominous.")
...
class Laundry_Room(Scene):
	...
	def enter(self):
		("You enter the laundry room, and inside you see a pile of cloths waiting to be washed. They smell pretty bad.")
        raise ValueError ('There was an error!')
        return self.action()
